...
const LANG_MAP = {
  ...
  "guia/cli.md": ["ps", "text", "ps"],
  "guia/inicio-rapido.md": ["text"],
  "herramientas/clxr.md": ["ps", "text"],
  "herramientas/lsp.md": ["ps"],
  "herramientas/maptype.md": ["ps", "text"],
  "herramientas/repl.md": ["ps", "text", "text", "text"],
  "lenguaje/multi-entorno.md": ["ps"],
  "runtime/errores.md": ["text", "ps", "text"],
  "runtime/jit.md": ["text"],
